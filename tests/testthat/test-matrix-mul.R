...
test_that("BLAS output rejects unproven external destination shapes", {
  ...
  # output). An external (m, m) destination cannot be safely reallocated,
  # so translation rejects it instead of passing it to dsyrk.
  fn <- function(x, m) {
